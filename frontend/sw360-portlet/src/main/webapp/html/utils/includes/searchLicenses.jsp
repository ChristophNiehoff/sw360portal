...
<script>
    firstRunLicenses = true;

    function showLicenseDialogWrapper(resultInputId) {
        require(['jquery', 'utils/includes/searchAndSelectIds'], function ($, idSearch) {

            $('#' + resultInputId + "Display").on('click', function () {
                showSetLicensesDialog(resultInputId)
            });
            ...
            function showSetLicensesDialog(resultInputId) {
                ...
                idSearch.openSearchDialog(true, resultInputId, htmlElements, functions, firstRunLicenses);
                firstRunLicenses = false;
            }
        });
    }
</script>
