...
<script>
    ...
    function showUserDialogWrapper(multiUser, resultInputId) {
        require(['jquery', 'utils/includes/searchAndSelectIds'], function($, idSearch) {

            $('#' + resultInputId + "Display").on('click', function() { showUserDialog(multiUser, resultInputId) });
            ...
            function showUserDialog(multiUser, resultInputId) {
                ...
                idSearch.openSearchDialog(multiUser, resultInputId, htmlElements, functions, firstRunUsers);
                firstRunUsers = false;
            }
        });
    }
